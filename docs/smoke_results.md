...
**Output:**
```
kud, wah Dik iq aq jidahu id jang uj rah jan kadppai ka simp yun hak lik Pul dg/d
```
...
**Output:**
```
kud, wah iq aq jang jidah Dik kad uj rah id janu kappaii lik simp yun hak Pul dg
```
...
| Sensible multilingual output | ✅ | 2/10 languages working |
...
**Success Rate:** 20%  
**Average Latency:** 1.28s per request
