...
def transliterate_if_needed(sentence):
    # Assuming no transliteration needed for Sindhi Arabic script
    return sentence
...
def process_text_file_split_in_half(input_path):
    ...
    def flush_batch(sentences, batch_num):
        output_file = 'sd_train.txt' if batch_num == 1 else 'sd_val.txt'
...
if __name__ == '__main__':
    process_text_file_split_in_half('sd.txt')
