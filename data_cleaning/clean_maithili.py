...
def transliterate_if_needed(sentence):
    # Assuming no transliteration needed for Maithili
    return sentence
...
def clean_sentence(sentence):
    # Keep Devanagari Unicode range U+0900 to U+097F, basic punctuation, digits, spaces
...
def process_text_file_split_in_half(input_path):
    ...
    def flush_batch(sentences, batch_num):
        output_file = 'mai_train.txt' if batch_num == 1 else 'mai_val.txt'
...
if __name__ == '__main__':
    process_text_file_split_in_half('mai.txt')
